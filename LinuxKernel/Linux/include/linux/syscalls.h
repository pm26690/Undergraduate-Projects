...
/*
 * System calls implemented in mailbox.c
*/

asmlinkage long sys_create_mbox_421(unsigned long id, int enable_crypt);
...
asmlinkage long sys_send_msg_421(unsigned long id, unsigned char __user *msg, long n, unsigned long key);

asmlinkage long sys_recv_msg_421(unsigned long id, unsigned char __user *msg, long n, unsigned long key);

asmlinkage long sys_peek_msg_421(unsigned long id, unsigned char __user *msg, long n, unsigned long key);
